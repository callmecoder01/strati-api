...
export interface ApiNewNew extends Schema.CollectionType {
  ...
  attributes: {
    ...
    ispopolarnews: Attribute.Boolean;
    isfreshnews: Attribute.Boolean;
    isPradeshnews: Attribute.Boolean;
    isLokpriya: Attribute.Boolean;
    isPolitics: Attribute.Boolean;
    idKhelkud: Attribute.Boolean;
    isEducation: Attribute.Boolean;
    IsHelth: Attribute.Boolean;
    isCrime: Attribute.Boolean;
    isFarmer: Attribute.Boolean;
    Reportername: Attribute.String;
    ReporterImage: Attribute.Media;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
